...
<body data-rsssl=1 class="home page-template-default page page-id-2 responsive-menu-slide-left">
    ...
    <div class="wrapper">
        ...
        <section class="experts-list-desc">
            <div class="container">
                <h1 class="class"><strong>Our Team</strong></h1>
                <p>We are a team of two licensed medical professionals and supportive staff<br> passionate about what we
                    do.</p>
                <img src="img/image/lapm-editedd-3.png" alt="logo" class="lapam" style="position:relative;top: 70px;">
            </div>
        </section>
        <style>
        @media only screen and (min-device-width: 320px) and (max-device-width: 600px) and (-webkit-min-device-pixel-ratio: 2) {
        ...
        <section class="experts-list-wrap">
            <div class="container">
                <div class="experts-list clearfix">
                    <div class="experts-list-item">
                        <div class="expert-img-holder" style="max-width:250px;position: relative;left: 2px;">
                            <a href="executiveTeam.php">
                                <img src="http://newyoumedspaandaesthetics.com/img/image/b-min.png"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image gig"
                                    alt="team" />
                            </a>
                        </div>
                        <div class="expert-desc">
                            <h4 style="position: relative;left: 2px;"><a href="executiveTeam.php">Dr. Jasper Ngomba</a>
                            </h4>
                            <p class="gigi" style="position:relative;left:2px;"> MD
                                Board <br>Certified in Internal Medicine
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="experts-list-item">
                        <div class="expert-img-holder" style="max-width:250px;">
                            <a href="executiveTeam.php">
                                <img src="" class="attachment-post-thumbnail size-post-thumbnail wp-post-image"></a>
                        </div>
                        <div class="expert-desc">
                    ...
                    <div class="experts-list-item">
                        <div class="expert-img-holder" style="max-width:250px;">
                            <a href="executiveTeam.php">
                                <img src="http://newyoumedspaandaesthetics.com/img/image/g.png"
                                    class="attachment-post-thumbnail size-post-thumbnail wp-post-image" alt="team"></a>
                        </div>
                        <div class="expert-desc">
                            <h4 class="karm">
                                <a href="executiveTeam.php">Karima Brahim</a>
                            </h4>
                            <p class="gigigig">MS, PA-C
                                Co-founder<br>
                                Associate Dir. Wellness <br>& Weight Loss
                            </p>
                        </div>
                    </div>
            ...
            <div class="footer-col">
                <ul class="social-icons">
                    <li><a href="https://web.facebook.com/BTLAestheticsInternational/?_rdc=1&_rdr" target="_blank"><img
                                src="http://newyoumedspaandaesthetics.com/img/1/34.png" alt="icon"></a></li>
